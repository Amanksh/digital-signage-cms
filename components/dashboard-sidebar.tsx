                ...
                <SidebarMenuItem key={route.href}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <span className={`text-base transition-all duration-200 ${pathname === route.href || pathname.startsWith(route.href + "/") ? "font-bold" : "font-normal"}`}>{route.name}</span>
                    </Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              ))}
          ...
          <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b border-border bg-background-interface px-6">
            ...
            <div className="w-full flex-1">
              <h1 className="text-xl font-semibold text-text-primary">
                {routes.find((route) => pathname === route.href || pathname.startsWith(route.href + "/"))?.name ||
                  "Dashboard"}
              </h1>
            </div>
            <Button
